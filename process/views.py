...
# Package Name : github4api
# Package Owner :  shervinbdndev
# Package Source : https://github.com/shervinbdndev/github4api/
...
class IndexView(View):
    ...
    def post(self: Self, request: HttpRequest) -> Union[HttpResponse, HttpResponseRedirect, HttpResponsePermanentRedirect]:
        ...
        if (username is not ''):
            if (checkUser(username=username) == True):
                ...
                scraper: Scrape = Scrape(data=request_handler)
